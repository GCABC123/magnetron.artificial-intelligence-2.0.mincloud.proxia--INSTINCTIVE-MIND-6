# magnetron.artificial-intelligence-2.0.mincloud.proxia--INSTINCTIVE-MIND-6


MAGNETRON ™: This is a Google Colab/Jupyter Notebook for developing a FACE RECOGNITION PROXIA  when working with ARTIFICIAL INTELLIGENCE 2.0 ™ (ARTIFICIAL INTELLIGENCE 2.0™ is part of MAGNETRON ™ TECHNOLOGY). The machine running the Notebook will be a MINDCLOUD on which you will be developing a PROXIA to recognize faces.
...
🌐 ARTIFICIAL INTELLIGENCE 2.0 ™ : FACE RECOGNITION PROXIA B
